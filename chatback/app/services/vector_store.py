...
class QdrantManager:
    def __init__(self):
        ...
        self.embeddings = OpenAIEmbeddings(
            api_key="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"
        )
