...
export const prototypeProtocol = import.meta.env.AI4MDE_PROTOTYPE_PROTO ?? import.meta.env.RUNNING_PROTOTYPE_PROTO ?? "http://";
export const prototypeHost = import.meta.env.AI4MDE_PROTOTYPE_HOST ?? import.meta.env.RUNNING_PROTOTYPE_HOST ?? "prototype.ai4mde.localhost";
