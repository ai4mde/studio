...
import EditMethods from "./EditMethods/EditMethods";
...
export { EditAttributes, EditMethods, EditName, EditLiterals, EditApplication, EditDimensions, EditBoolean, EditSwimlane };
export default {
    EditAttributes,
    EditMethods,
    EditName,
