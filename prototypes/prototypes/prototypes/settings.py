...
if environ.get("DEBUG", "True").lower() == "false":
    DEBUG = False
    ALLOWED_HOSTS = [environ.get("HOSTNAME", "prototypes.ai4mde.localhost"), "localhost"]

INSTALLED_APPS = [
    "daphne",  # ext: Use Daphne as ASGI server
    "prototypes",  # The main app / project is the prototypes application
    "corsheaders",
...
ASGI_APPLICATION = "prototypes.asgi.application"
...
CSRF_TRUSTED_ORIGINS = [
    ...
    "http://localhost:5173",
    "http://" + environ.get("HOSTNAME", "prototypes.ai4mde.localhost"),
    "https://" + environ.get("HOSTNAME", "prototypes.ai4mde.localhost"),
