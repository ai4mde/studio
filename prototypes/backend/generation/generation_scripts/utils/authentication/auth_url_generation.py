...
def generate_noauth_home_urls(project_name: str) -> bool:
    TEMPLATE_PATH = "/usr/src/prototypes/backend/generation/templates/authentication/noauth_urls.py.jinja2"
    OUTPUT_FILE_PATH = "/usr/src/prototypes/generated_prototypes/" + project_name_sanitization(project_name) + "/noauth_home/urls.py"
