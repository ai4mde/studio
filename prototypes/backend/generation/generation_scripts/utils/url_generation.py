...
def generate_urls(application_component: ApplicationComponent) -> bool:
    ...
    OUTPUT_FILE_PATH = "/usr/src/prototypes/generated_prototypes/" + project_name_sanitization(project_name) + "/" + app_name_sanitization(application_name)+ "/urls.py"
