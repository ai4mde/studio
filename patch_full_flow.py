...
existing_related  = {'id': '78f1b83a-0dd5-42db-9ffc-d3325b9a1183',   'name': 'Related Products','class': 'f72b270d-fea0-4160-9168-b3f4324d065d', 'layout': 'card',    'col_span': 12, 'text': '', 'style': style('blue',   columns='4'), 'attributes': [attr('image_url','image'), attr('name'), attr('price','int')], 'operations': ops()}
