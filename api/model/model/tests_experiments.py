...
class ExperimentEndpointTests(TestCase):
    ...
    def test_refine_model_endpoint_defaults_to_semantic_deterministic_profile(self):
        persist_semantic_generation_artifacts(
            system_id=str(self.system.id),
            process_text="Receive request, validate it, send confirmation.",
            pipeline_profile="semantic_deterministic",
        ...
        with patch(
            ...
            return_value={
                "artifact": {
                    ...
                    "refinement_trace": {"user_instruction": "Keep the current process unchanged."},
                }
            },
            ...
            response = self.client.post(
                ...
                data={
                    "process_text": "Receive request, validate it, send confirmation.",
                    "selected_system_id": str(self.system.id),
                    "refinement_instruction": "Keep the current process unchanged.",
                },
                content_type="application/json",
            )
    ...
    def test_refine_model_endpoint_legacy_profile_requires_explicit_selection(self):
        refined_export = convert_to_ai4mde(
            clean_model={
                "nodes": [
                    {"id": "n1", "type": "initial"},
